...
export default function Navbar({ fixed }) {
  ...
  return (
    <>
      <nav
        className="relative flex flex-wrap items-center justify-between px-2 py-3 bg-light-500 mb-3"
        style={{ width: "100%", marginTop: "0px" }}
      >
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            <Link href="/">
              <a className="text-4xl font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase text-black">
                HASSAN TURI
              </a>
            </Link>
            <button
              ...
              <li className="nav-item">
                <div className="dropdown">
                  ...
                  <div className="dropdown-content">
                    <Link href="/stories/grapes">
                      <a>Grapes Of Wrath</a>
                    </Link>
                    <Link href="/stories/forgotten">
                      <a>Forgotten Land</a>
                    </Link>
                    <Link href="/stories/rawalpindi">
                      <a>Rawalpindi Under Seige</a>
                    </Link>
                  </div>
                </div>
              </li>
